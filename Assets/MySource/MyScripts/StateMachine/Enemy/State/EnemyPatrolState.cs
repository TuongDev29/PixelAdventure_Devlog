...
public class EnemyPatrolState : BaseEnemyState
{
    ...
    public EnemyPatrolState(Blackboard<EEnemyBlackBoard> blackboard) : base()
    {
    ...
    {
        this.enemyCtrl.anim.SetBool("isWalking", true);
    ...
    public override void Excute()
    {
        ...
        enemyCtrl.rb.velocity = new Vector2(moveDirection * enemyCtrl.EnemyData.walkSpeed, enemyCtrl.rb.velocity.y);
    }

    public override void Exit()
    {
        this.enemyCtrl.anim.SetBool("isWalking", false);
        this.ResetVelocity();
    }
