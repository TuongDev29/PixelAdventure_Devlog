...
public class ChickenStateMachine : EnemyStateMachine
{
    ...
    public ChickenStateMachine(Blackboard<EEnemyBlackBoard> blackboard) : base(blackboard)
    {
    }
    ...
    protected override void InitializeTransition()
    {
        ...
        //Transitions for ALl state
        this.AddTransitionForAllStates(EEnemyState.Dead, IsDead);
        this.AddTransitionForAllStates(EEnemyState.Chase, IsPlayerInRange);

        //Transiton for Dead State
